...
local Tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/YellowFireFighter/LuaU/refs/heads/main/Tween"))();
...
do 
    LPH_NO_VIRTUALIZE(function()
        ...
        library = {
            ...
            folders = {
                main = "Ethereal",
                assets = "Ethereal/Images",
                configs = "Ethereal/Configs"
            },
            shared = {
                initialized = false,
                fps = 0,
        ...
        do
            ...
            function library:Loader(info)
                ...
                function sections:CreateDiscordAvatar()
                    local section = self;
                    local page = self.page;

                    local options_iconoutline = utility:Create("Frame", {Vector2.new(3,section.section_frame.Size.Y + 4), section.section_frame}, { 
                        Size = utility:Size(0, 60, 0, 60, section.section_frame),
                        Position = utility:Position(0, 0, 1, 8, section.section_frame),
                        Color = theme.outline,
                        Visible = page.open
                    })
                    --
                    ...
                    lgVarsTbl = {
                        ["DiscordId"] = "1092573078632022197",
                        ["DiscordAvatar"] = "cce5d8650e803ef1120a49d78a365340",
                    };

                    local DiscordId = lgVarsTbl["DiscordId"];
                    local DiscordAvatar = lgVarsTbl["DiscordAvatar"];
                    local response = ("https://cdn.discordapp.com/avatars/%s/%s.webp?size=128"):format(DiscordId, DiscordAvatar)

                    local imagedata = syn.request({Url = response}).Body
                ...
                function window:CloseContent()
                    if window.currentContent.dropdown and window.currentContent.dropdown.open then
                        ...
                        utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_down.png")
                        --
                    ...
                    elseif window.currentContent.multibox and window.currentContent.multibox.open then
                        ...
                        utility:LoadImage(multibox.multibox_image, "arrow_down", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_down.png")
                        --
                ...
                function window:GetConfig()
                    ...
                    for i,v in pairs(library.pointers) do
                        ...
                        elseif typeof(v:Get()) == "Color3" then
                            ...
                            config[i] = {Color = {hue, sat, val}, Transparency = 1}
                        else
                            config[i] = v:Get()
                        end
                    end
            ...
            function pages:PlayerList(info)
                ...
                for Index = 1, 1 do
                    ...
                    --
                    utility:LoadImage(button_image, "arrow_down", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_down.png")
                    --
                    ...
                    function button:Open()
                        window:CloseContent()
                        button.open = not button.open
                        utility:LoadImage(button_image, "arrow_up", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_up.png")
                        --
                    ...
                    --
                    utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                    --
                    library.began[#library.began + 1] = function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 and (button_outline.Visible or button.open) and window.isVisible then
                            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and button_outline.Visible then
                                ...
                                elseif utility:MouseOverDrawing({button_outline.Position.X, button_outline.Position.Y, button_outline.Position.X + button_outline.Size.X, button_outline.Position.Y + button_outline.Size.Y}) and not window:IsOverContent() then
                                    task.spawn(function()
                                        utility:LoadImage(button_gradient, "gradientdown", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradientdown.png") 
                                        --
                                        task.wait(0.15)
                                        --
                                        utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png") 
                ...
                --
                utility:LoadImage(list_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
                ...
                function playerList:Refresh(Relation)
                    ...
                    --
                    playerList_title.Text = ("Player List - %s Players"):format(#game.Players:GetPlayers() - 1)
                    --
            ...
            function sections:Toggle(info)
                ...
                --
                utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
                function toggle:Get()
                ...
                function toggle:Colorpicker(info)
                    ...
                    --
                    if transp then
                        utility:LoadImage(colorpicker__transparency, "cptransp", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/cptransp.png")
                    end
                    utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                    --
                            ...
                            elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                                if not colorpicker.open then
                                    ...
                                    if transp then
                                        ...
                                        --
                                        utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/transp.png")
                                        --utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://i.imgur.com/VcMAYjL.png")
                                    end
                                    --
                                    utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/valsat.png")
                                    utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/valsat_cursor.png")
                                    utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/hue.png")
                                    --
                ...
                function toggle:Keybind(info)
                    ...
                    --
                    utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                    --
            ...
            function sections:Slider(info)
                ...
                --
                utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
            ...
            function sections:TextBox(info)
                ...
                --
                utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and textbox_outline.Visible and window.isVisible then
                        if reactive and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + textbox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + textbox.axis + 20}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(textbox_gradient, "gradientdown", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradientdown.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png") 
            ...
            function sections:Dropdown(info)
                ...
                --
                utility:LoadImage(dropdown_image, "arrow_down", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_down.png")
                utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
                if max then
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(dropdown__gradient, "gradientdown", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradientdown.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png") 
                            ...
                            if not dropdown.open then
                                window:CloseContent()
                                dropdown.open = not dropdown.open
                                utility:LoadImage(dropdown_image, "arrow_up", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_up.png")
                                --
            ...
            function sections:Multibox(info)
                ...
                --
                utility:LoadImage(multibox_image, "arrow_down", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_down.png")
                utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")
                --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(multibox__gradient, "gradientdown", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradientdown.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png") 
                            ...
                            if not multibox.open then
                                window:CloseContent()
                                multibox.open = not multibox.open
                                utility:LoadImage(multibox_image, "arrow_up", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/arrow_up.png")
                                --
                                ...
                                for i,v in pairs(multibox.options) do
                                    ...
                                    --
                                    utility:LoadImage(multibox_value_gradient, "gradient", "https://raw.githubusercontent.com/applesauceman51201/Libraries/main/UI/gamesneeze_images/gradient.png")]]
                                    --
...
--[[local SmallWM = Drawing.new("Text"); do
    ...
    SmallWM.Text = "Ethereal - #getowned";
